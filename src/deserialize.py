...
opcodes = Enumeration("Opcodes", [
    ("OP_0", 0x00), ("OP_IDENTITY", 0x01), ("OP_ORDER", 0x02), ("OP_ESCROW", 0x03), ("OP_ACCEPT", 0x04), ("OP_EXPIRE", 0x05),
    ("OP_PROVENANCE", 0x06), ("OP_EXECUTE", 0x07), ("OP_RELEASE", 0x08), ("OP_UTXO", 0x09), ("OP_TAO_RESERVED1", 0x0a),
    ("OP_TAO_RESERVED2", 0x0b), ("OP_TAO_RESERVED3", 0x0c), ("OP_TAO_RESERVED4", 0x0d), ("OP_TAO_RESERVED5", 0x0e),
    ("OP_TAO_RESERVED6", 0x0f), ("OP_TAO_RESERVED7", 0x10), ("OP_TAO_RESERVED8", 0x11), ("OP_TAO_RESERVED9", 0x12), 
	("OP_TAO_RESERVED0", 0x13), ("OP_PUSHDATA1", 0x4c), ("OP_PUSHDATA2", 0x4d), ("OP_PUSHDATA4", 0x4f), "OP_1NEGATE", "OP_RESERVED",
