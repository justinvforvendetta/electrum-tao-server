...
Tao Electrum Server will run in private mode (default). In private mode, 
`electrum-tao-server peers` will always return an empty list.
...
composing the IRC nickname to identify your server on #electrum-tao.
